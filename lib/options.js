...
module.exports = function options (command, program) {
  ...
  return clean({
    ...
    server: options.server === true ? 'node .' : options.server,
    ...
    // url path to bundle
    assets: assets(path.join(dir, dist, 'client')),
...
module.exports.recomputeAssets = function recomputeAssets (options) {
  return Object.assign({}, options, {
    assets: assets(path.join(options.dir, options.dist, 'client'))
  })
}
...
function assets (root) {
  if (env() === 'development' || env() === 'test') {
    return { js: ['/client/bundle.js'], css: [], other: [], runtime: null }
  }
