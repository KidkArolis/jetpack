...
module.exports = function options(command = 'dev', program = {}) {
  ...
  const options = Object.assign(
    {},
    configFromFile,
    pick(program, ['port', 'dir', 'exec', 'jsx', 'hot', 'config', 'minify', 'quiet', 'verbose'])
  )
  ...
  return clean({
    ...
    exec: program.exec ? first([program.exec, configFromFile.exec, 'node .'], ifString) : false,
    ...
    coverage:
      program.args && program.args.length && program.args[0].coverage !== undefined ? program.args[0].coverage : false,
