...
async function createConfig (options) {
  ...
  if (options.production) {
    ...
    config.plugins.push(new ManifestPlugin({ fileName: options.modern ? 'manifest.json' : 'manifest.legacy.json' }))
  ...
  await plugins.gzip(config, options)
