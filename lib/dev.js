  ...
  const server = new RspackDevServer(
    {
      ...
      setupMiddlewares: (middlewares) => {
        ...
        addProxyMiddlewares(middlewares, options, log)
...
function addProxyMiddlewares(middlewares, options, log) {
  ...
  Object.keys(options.proxy).forEach((endpoint) => {
    router.all(endpoint, proxyFactory(options.proxy[endpoint], log))
  })
