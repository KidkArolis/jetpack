...
program
  .version(version, '-v, --version', 'print the version of jetpack and rspack')
  .arguments('[path]')
  ...
  .option('-i, --print-config', 'print the rspack config object used in the current command')
...
program.on('--help', function (here) {
  ...
  console.log(`  Rspack ${rspackPkg.version}`)
  console.log()
})
