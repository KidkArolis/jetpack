...
program
  ...
  .option('-m, --no-minify', 'disable minification')
  .option('-c, --config', 'config file to use, defaults to jetpack.config.js')
  .option('-l, --legacy', 'build a legacy bundle instead of modern')
...
if (!program.rawArgs.includes('--no-minify') && !program.rawArgs.includes('-m')) {
